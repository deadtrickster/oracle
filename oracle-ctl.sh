...
SERVICES=(oracle-ask-bridge oracle-lsp-bridge oracle-ingest-bridge oracle-reranker
          codebase-memory-bridge source-grep-bridge emacs-bridge git-bridge oracle-docs)
